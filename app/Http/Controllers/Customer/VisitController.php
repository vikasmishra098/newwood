...
public function index(Request $request)
{
    ...
    return view('customer.visits.index', compact('visits'));
}
...
public function destroy($id)
{
    ...
    return redirect()->route('customer.visits.index')->with('success', 'Visit deleted successfully.');
}
    ...
    public function create()
{
    ...
    $employees = User::where('role', 'customer')->orWhere('role', 'customer')->get(); // or any role filter you want

    return view('customer.visits.create', compact('companies', 'employees'));
}
    ...
    'status'          => 'required|string|in:pending,resolved,completed', // Optional: restrict valid statuses
        ...
        return redirect()->route('customer.visits.index')->with('success', 'Visit created successfully.');
    }
  ...
  public function edit($id)
    {
        ...
        return view('customer.visits.edit', compact('visit', 'employees', 'companies'));
    }
    ...
    public function update(Request $request, $id)
    {
     $visit = Visit::findOrFail($id);
        ...
        return redirect()->route('customer.visits.index')->with('success', 'Visit updated!');
    }
