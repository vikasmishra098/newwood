    ...
    public function create()
{
    ...
    return view('admin.visits.create', compact('companies', 'employees'));
}
    ...
    'status'          => 'required|string|in:pending,resolved,completed', // Optional: restrict valid statuses
        ...
        return redirect()->route('admin.visits.index')->with('success', 'Visit created successfully.');
    }
  ...
  public function edit($id)
    {
        ...
        return view('admin.visits.edit', compact('visit', 'employees', 'companies'));
    }
    ...
    public function update(Request $request, $id)
    {
     $visit = Visit::findOrFail($id);
        ...
        return redirect()->route('admin.visits.index')->with('success', 'Visit updated!');
    }
