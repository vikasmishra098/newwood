    ...
    public function index(Request $request)
{
    ...
    if ($filter === 'yesterday') {
        ...
        $followups = Followup::with('relatedQuery')->get(); // 👈 All records
    } else { 
        // default → today
        $followups = Followup::with('relatedQuery')
...
public function getFollowupsJson()
{
    ...
    public function create($query_id)
    {
        ...
        return view('admin.followups.create', compact('query'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.followups.index')->with('success', 'Followup added successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.followups.index')->with('success', 'Followup updated.');
    }
}
