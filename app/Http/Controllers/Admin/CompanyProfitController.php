...
class CompanyProfitController extends Controller
{
    ...
    {
        return view('admin.companyprofit.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.companyprofit.view')->with('success', 'Record Added Successfully!');
    }
   ...
   public function view(Request $request)
{
    ...
    return view('admin.companyprofit.view', compact('profits', 'years', 'totalProfit', 'totalLoss'));
}
