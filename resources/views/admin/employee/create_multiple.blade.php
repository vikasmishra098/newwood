...
<div class="container">
    ...
    <form action="{{ route('admin.employee.storeMultiple') }}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <select name="employee_ids[]" class="form-control" multiple required size="6">
                @foreach(\App\Models\User::where('role', '!=', 'admin')->get() as $employee)
