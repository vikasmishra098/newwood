...
<div class="container">
    <h2>Company List</h2>
    <a href="{{ route('admin.companies.create') }}" class="btn btn-primary mb-3">➕ Add Company</a>
        ...
        <tbody>
            ...
            @foreach($companies as $company)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.companies.edit', $company->id) }}" class="btn btn-sm btn-info">✏️ </a>
