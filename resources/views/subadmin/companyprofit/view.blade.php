...
<div class="container">
    ...
    <!-- Filter Form -->
    <form method="GET" action="{{ route('subadmin.companyprofit.view') }}" class="mb-3 d-flex gap-2">
        ...
        <a href="{{ route('subadmin.companyprofit.view') }}" class="btn btn-secondary">Reset</a>
    </form>
